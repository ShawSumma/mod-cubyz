...
enum web49_opcode_enum_t {
    ...
    WEB49_OPCODE_CALL0,
    WEB49_OPCODE_CALL1,
    WEB49_OPCODE_CALL_INDIRECT1,
    WEB49_OPCODE_CALL_INDIRECT0,

    // ref types
    WEB49_OPCODE_DATA_DROP,
    WEB49_OPCODE_REF_NULL,
    WEB49_OPCODE_REF_IS_NULL,
    WEB49_OPCODE_REF_FUNC,
    WEB49_OPCODE_TABLE_GET,
    WEB49_OPCODE_TABLE_SET,
    ...
    // SIMD
    WEB49_MIN_SIMD_OPCODE_NUM,
    WEB49_OPCODE_V128_LOAD = WEB49_MIN_SIMD_OPCODE_NUM,
    WEB49_OPCODE_V128_LOAD8X8_S,
    WEB49_OPCODE_V128_LOAD8X8_U,
    WEB49_OPCODE_V128_LOAD16X4_S,
    WEB49_OPCODE_V128_LOAD16X4_U,
    WEB49_OPCODE_V128_LOAD32X2_S,
    WEB49_OPCODE_V128_LOAD32X2_U,
    WEB49_OPCODE_V128_LOAD8_SPLAT,
    WEB49_OPCODE_V128_LOAD16_SPLAT,
    WEB49_OPCODE_V128_LOAD32_SPLAT,
    WEB49_OPCODE_V128_LOAD64_SPLAT,
    WEB49_OPCODE_V128_STORE,
    WEB49_OPCODE_V128_CONST,
    WEB49_OPCODE_I8X16_SHUFFLE,
    WEB49_OPCODE_I8X16_SWIZZLE,
    WEB49_OPCODE_I8X16_SPLAT,
    WEB49_OPCODE_I16X8_SPLAT,
    WEB49_OPCODE_I32X4_SPLAT,
    WEB49_OPCODE_I64X2_SPLAT,
    WEB49_OPCODE_F32X4_SPLAT,
    WEB49_OPCODE_F64X2_SPLAT,
    WEB49_OPCODE_I8X16_EXTRACT_LANE_S,
    WEB49_OPCODE_I8X16_EXTRACT_LANE_U,
    WEB49_OPCODE_I8X16_REPLACE_LANE,
    WEB49_OPCODE_I16X8_EXTRACT_LANE_S,
    WEB49_OPCODE_I16X8_EXTRACT_LANE_U,
    WEB49_OPCODE_I16X8_REPLACE_LANE,
    WEB49_OPCODE_I32X4_EXTRACT_LANE,
    WEB49_OPCODE_I32X4_REPLACE_LANE,
    WEB49_OPCODE_I64X2_EXTRACT_LANE,
    WEB49_OPCODE_I64X2_REPLACE_LANE,
    WEB49_OPCODE_F32X4_EXTRACT_LANE,
    WEB49_OPCODE_F32X4_REPLACE_LANE,
    WEB49_OPCODE_F64X2_EXTRACT_LANE,
    WEB49_OPCODE_F64X2_REPLACE_LANE,
    WEB49_OPCODE_I8X16_EQ,
    WEB49_OPCODE_I8X16_NE,
    WEB49_OPCODE_I8X16_LT_S,
    WEB49_OPCODE_I8X16_LT_U,
    WEB49_OPCODE_I8X16_GT_S,
    WEB49_OPCODE_I8X16_GT_U,
    WEB49_OPCODE_I8X16_LE_S,
    WEB49_OPCODE_I8X16_LE_U,
    WEB49_OPCODE_I8X16_GE_S,
    WEB49_OPCODE_I8X16_GE_U,
    WEB49_OPCODE_I16X8_EQ,
    WEB49_OPCODE_I16X8_NE,
    WEB49_OPCODE_I16X8_LT_S,
    WEB49_OPCODE_I16X8_LT_U,
    WEB49_OPCODE_I16X8_GT_S,
    WEB49_OPCODE_I16X8_GT_U,
    WEB49_OPCODE_I16X8_LE_S,
    WEB49_OPCODE_I16X8_LE_U,
    WEB49_OPCODE_I16X8_GE_S,
    WEB49_OPCODE_I16X8_GE_U,
    WEB49_OPCODE_I32X4_EQ,
    WEB49_OPCODE_I32X4_NE,
    WEB49_OPCODE_I32X4_LT_S,
    WEB49_OPCODE_I32X4_LT_U,
    WEB49_OPCODE_I32X4_GT_S,
    WEB49_OPCODE_I32X4_GT_U,
    WEB49_OPCODE_I32X4_LE_S,
    WEB49_OPCODE_I32X4_LE_U,
    WEB49_OPCODE_I32X4_GE_S,
    WEB49_OPCODE_I32X4_GE_U,
    WEB49_OPCODE_F32X4_EQ,
    WEB49_OPCODE_F32X4_NE,
    WEB49_OPCODE_F32X4_LT,
    WEB49_OPCODE_F32X4_GT,
    WEB49_OPCODE_F32X4_LE,
    WEB49_OPCODE_F32X4_GE,
    WEB49_OPCODE_F64X2_EQ,
    WEB49_OPCODE_F64X2_NE,
    WEB49_OPCODE_F64X2_LT,
    WEB49_OPCODE_F64X2_GT,
    WEB49_OPCODE_F64X2_LE,
    WEB49_OPCODE_F64X2_GE,
    WEB49_OPCODE_V128_NOT,
    WEB49_OPCODE_V128_AND,
    WEB49_OPCODE_V128_ANDNOT,
    WEB49_OPCODE_V128_OR,
    WEB49_OPCODE_V128_XOR,
    WEB49_OPCODE_V128_BITSELECT,
    WEB49_OPCODE_V128_ANY_TRUE,
    WEB49_OPCODE_V128_LOAD8_LANE,
    WEB49_OPCODE_V128_LOAD16_LANE,
    WEB49_OPCODE_V128_LOAD32_LANE,
    WEB49_OPCODE_V128_LOAD64_LANE,
    WEB49_OPCODE_V128_STORE8_LANE,
    WEB49_OPCODE_V128_STORE16_LANE,
    WEB49_OPCODE_V128_STORE32_LANE,
    WEB49_OPCODE_V128_STORE64_LANE,
    WEB49_OPCODE_V128_LOAD32_ZERO,
    WEB49_OPCODE_V128_LOAD64_ZERO,
    WEB49_OPCODE_F32X4_DEMOTE_F64X2_ZERO,
    WEB49_OPCODE_F64X2_PROMOTE_LOW_F32X4,
    WEB49_OPCODE_I8X16_ABS,
    WEB49_OPCODE_I8X16_NEG,
    WEB49_OPCODE_I8X16_POPCNT,
    WEB49_OPCODE_I8X16_ALL_TRUE,
    WEB49_OPCODE_I8X16_BITMASK,
    WEB49_OPCODE_I8X16_NARROW_I16X8_S,
    WEB49_OPCODE_I8X16_NARROW_I16X8_U,
    WEB49_OPCODE_F32X4_CEIL,
    WEB49_OPCODE_F32X4_FLOOR,
    WEB49_OPCODE_F32X4_TRUNC,
    WEB49_OPCODE_F32X4_NEAREST,
    WEB49_OPCODE_I8X16_SHL,
    WEB49_OPCODE_I8X16_SHR_S,
    WEB49_OPCODE_I8X16_SHR_U,
    WEB49_OPCODE_I8X16_ADD,
    WEB49_OPCODE_I8X16_ADD_SAT_S,
    WEB49_OPCODE_I8X16_ADD_SAT_U,
    WEB49_OPCODE_I8X16_SUB,
    WEB49_OPCODE_I8X16_SUB_SAT_S,
    WEB49_OPCODE_I8X16_SUB_SAT_U,
    WEB49_OPCODE_F64X2_CEIL,
    WEB49_OPCODE_F64X2_FLOOR,
    WEB49_OPCODE_I8X16_MIN_S,
    WEB49_OPCODE_I8X16_MIN_U,
    WEB49_OPCODE_I8X16_MAX_S,
    WEB49_OPCODE_I8X16_MAX_U,
    WEB49_OPCODE_F64X2_TRUNC,
    WEB49_OPCODE_I8X16_AVGR_U,
    WEB49_OPCODE_I16X8_EXTADD_PAIRWISE_I8X16_S,
    WEB49_OPCODE_I16X8_EXTADD_PAIRWISE_I8X16_U,
    WEB49_OPCODE_I32X4_EXTADD_PAIRWISE_I16X8_S,
    WEB49_OPCODE_I32X4_EXTADD_PAIRWISE_I16X8_U,
    WEB49_OPCODE_I16X8_ABS,
    WEB49_OPCODE_I16X8_NEG,
    WEB49_OPCODE_I16X8_Q15MULR_SAT_S,
    WEB49_OPCODE_I16X8_ALL_TRUE,
    WEB49_OPCODE_I16X8_BITMASK,
    WEB49_OPCODE_I16X8_NARROW_I32X4_S,
    WEB49_OPCODE_I16X8_NARROW_I32X4_U,
    WEB49_OPCODE_I16X8_EXTEND_LOW_I8X16_S,
    WEB49_OPCODE_I16X8_EXTEND_HIGH_I8X16_S,
    WEB49_OPCODE_I16X8_EXTEND_LOW_I8X16_U,
    WEB49_OPCODE_I16X8_EXTEND_HIGH_I8X16_U,
    WEB49_OPCODE_I16X8_SHL,
    WEB49_OPCODE_I16X8_SHR_S,
    WEB49_OPCODE_I16X8_SHR_U,
    WEB49_OPCODE_I16X8_ADD,
    WEB49_OPCODE_I16X8_ADD_SAT_S,
    WEB49_OPCODE_I16X8_ADD_SAT_U,
    WEB49_OPCODE_I16X8_SUB,
    WEB49_OPCODE_I16X8_SUB_SAT_S,
    WEB49_OPCODE_I16X8_SUB_SAT_U,
    WEB49_OPCODE_F64X2_NEAREST,
    WEB49_OPCODE_I16X8_MUL,
    WEB49_OPCODE_I16X8_MIN_S,
    WEB49_OPCODE_I16X8_MIN_U,
    WEB49_OPCODE_I16X8_MAX_S,
    WEB49_OPCODE_I16X8_MAX_U,
    WEB49_OPCODE_I16X8_AVGR_U,
    WEB49_OPCODE_I16X8_EXTMUL_LOW_I8X16_S,
    WEB49_OPCODE_I16X8_EXTMUL_HIGH_I8X16_S,
    WEB49_OPCODE_I16X8_EXTMUL_LOW_I8X16_U,
    WEB49_OPCODE_I16X8_EXTMUL_HIGH_I8X16_U,
    WEB49_OPCODE_I32X4_ABS,
    WEB49_OPCODE_I32X4_NEG,
    WEB49_OPCODE_I32X4_ALL_TRUE,
    WEB49_OPCODE_I32X4_BITMASK,
    WEB49_OPCODE_I32X4_EXTEND_LOW_I16X8_S,
    WEB49_OPCODE_I32X4_EXTEND_HIGH_I16X8_S,
    WEB49_OPCODE_I32X4_EXTEND_LOW_I16X8_U,
    WEB49_OPCODE_I32X4_EXTEND_HIGH_I16X8_U,
    WEB49_OPCODE_I32X4_SHL,
    WEB49_OPCODE_I32X4_SHR_S,
    WEB49_OPCODE_I32X4_SHR_U,
    WEB49_OPCODE_I32X4_ADD,
    WEB49_OPCODE_I32X4_SUB,
    WEB49_OPCODE_I32X4_MUL,
    WEB49_OPCODE_I32X4_MIN_S,
    WEB49_OPCODE_I32X4_MIN_U,
    WEB49_OPCODE_I32X4_MAX_S,
    WEB49_OPCODE_I32X4_MAX_U,
    WEB49_OPCODE_I32X4_DOT_I16X8_S,
    WEB49_OPCODE_I32X4_EXTMUL_LOW_I16X8_S,
    WEB49_OPCODE_I32X4_EXTMUL_HIGH_I16X8_S,
    WEB49_OPCODE_I32X4_EXTMUL_LOW_I16X8_U,
    WEB49_OPCODE_I32X4_EXTMUL_HIGH_I16X8_U,
    WEB49_OPCODE_I64X2_ABS,
    WEB49_OPCODE_I64X2_NEG,
    WEB49_OPCODE_I64X2_ALL_TRUE,
    WEB49_OPCODE_I64X2_BITMASK,
    WEB49_OPCODE_I64X2_EXTEND_LOW_I32X4_S,
    WEB49_OPCODE_I64X2_EXTEND_HIGH_I32X4_S,
    WEB49_OPCODE_I64X2_EXTEND_LOW_I32X4_U,
    WEB49_OPCODE_I64X2_EXTEND_HIGH_I32X4_U,
    WEB49_OPCODE_I64X2_SHL,
    WEB49_OPCODE_I64X2_SHR_S,
    WEB49_OPCODE_I64X2_SHR_U,
    WEB49_OPCODE_I64X2_ADD,
    WEB49_OPCODE_I64X2_SUB,
    WEB49_OPCODE_I64X2_MUL,
    WEB49_OPCODE_I64X2_EQ,
    WEB49_OPCODE_I64X2_NE,
    WEB49_OPCODE_I64X2_LT_S,
    WEB49_OPCODE_I64X2_GT_S,
    WEB49_OPCODE_I64X2_LE_S,
    WEB49_OPCODE_I64X2_GE_S,
    WEB49_OPCODE_I64X2_EXTMUL_LOW_I32X4_S,
    WEB49_OPCODE_I64X2_EXTMUL_HIGH_I32X4_S,
    WEB49_OPCODE_I64X2_EXTMUL_LOW_I32X4_U,
    WEB49_OPCODE_I64X2_EXTMUL_HIGH_I32X4_U,
    WEB49_OPCODE_F32X4_ABS,
    WEB49_OPCODE_F32X4_NEG,
    WEB49_OPCODE_F32X4_SQRT,
    WEB49_OPCODE_F32X4_ADD,
    WEB49_OPCODE_F32X4_SUB,
    WEB49_OPCODE_F32X4_MUL,
    WEB49_OPCODE_F32X4_DIV,
    WEB49_OPCODE_F32X4_MIN,
    WEB49_OPCODE_F32X4_MAX,
    WEB49_OPCODE_F32X4_PMIN,
    WEB49_OPCODE_F32X4_PMAX,
    WEB49_OPCODE_F64X2_ABS,
    WEB49_OPCODE_F64X2_NEG,
    WEB49_OPCODE_F64X2_SQRT,
    WEB49_OPCODE_F64X2_ADD,
    WEB49_OPCODE_F64X2_SUB,
    WEB49_OPCODE_F64X2_MUL,
    WEB49_OPCODE_F64X2_DIV,
    WEB49_OPCODE_F64X2_MIN,
    WEB49_OPCODE_F64X2_MAX,
    WEB49_OPCODE_F64X2_PMIN,
    WEB49_OPCODE_F64X2_PMAX,
    WEB49_OPCODE_I32X4_TRUNC_SAT_F32X4_S,
    WEB49_OPCODE_I32X4_TRUNC_SAT_F32X4_U,
    WEB49_OPCODE_F32X4_CONVERT_I32X4_S,
    WEB49_OPCODE_F32X4_CONVERT_I32X4_U,
    WEB49_OPCODE_I32X4_TRUNC_SAT_F64X2_S_ZERO,
    WEB49_OPCODE_I32X4_TRUNC_SAT_F64X2_U_ZERO,
    WEB49_OPCODE_F64X2_CONVERT_LOW_I32X4_S,
    WEB49_OPCODE_F64X2_CONVERT_LOW_I32X4_U,
    WEB49_MAX_SIMD_OPCODE_NUM = WEB49_OPCODE_F64X2_CONVERT_LOW_I32X4_U,
