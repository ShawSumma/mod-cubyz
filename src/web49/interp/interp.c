...
uint32_t web49_interp_read_instr(web49_read_block_state_t *state, web49_instr_t cur, uint32_t local) {
    ...
    if (cur.opcode == WEB49_OPCODE_CALL_INDIRECT0) {
        ...
        build->code[build->ncode++].data.i32_u = cur.immediate.call_indirect.table;
...
#define TABLE_SIMD(x) TABLE_PUTV(x, x)
        ...
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD8X8_S),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD8X8_U),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD16X4_S),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD16X4_U),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD32X2_S),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD32X2_U),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD8_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD16_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD32_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD64_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_V128_STORE),
        TABLE_SIMD(WEB49_OPCODE_V128_CONST),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SHUFFLE),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SWIZZLE),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_I32X4_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_I64X2_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_F32X4_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_F64X2_SPLAT),
        TABLE_SIMD(WEB49_OPCODE_I8X16_EXTRACT_LANE_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_EXTRACT_LANE_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_REPLACE_LANE),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTRACT_LANE_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTRACT_LANE_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_REPLACE_LANE),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTRACT_LANE),
        TABLE_SIMD(WEB49_OPCODE_I32X4_REPLACE_LANE),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTRACT_LANE),
        TABLE_SIMD(WEB49_OPCODE_I64X2_REPLACE_LANE),
        TABLE_SIMD(WEB49_OPCODE_F32X4_EXTRACT_LANE),
        TABLE_SIMD(WEB49_OPCODE_F32X4_REPLACE_LANE),
        TABLE_SIMD(WEB49_OPCODE_F64X2_EXTRACT_LANE),
        TABLE_SIMD(WEB49_OPCODE_F64X2_REPLACE_LANE),
        TABLE_SIMD(WEB49_OPCODE_I8X16_EQ),
        TABLE_SIMD(WEB49_OPCODE_I8X16_NE),
        TABLE_SIMD(WEB49_OPCODE_I8X16_LT_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_LT_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_GT_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_GT_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_LE_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_LE_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_GE_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_GE_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EQ),
        TABLE_SIMD(WEB49_OPCODE_I16X8_NE),
        TABLE_SIMD(WEB49_OPCODE_I16X8_LT_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_LT_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_GT_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_GT_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_LE_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_LE_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_GE_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_GE_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EQ),
        TABLE_SIMD(WEB49_OPCODE_I32X4_NE),
        TABLE_SIMD(WEB49_OPCODE_I32X4_LT_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_LT_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_GT_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_GT_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_LE_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_LE_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_GE_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_GE_U),
        TABLE_SIMD(WEB49_OPCODE_F32X4_EQ),
        TABLE_SIMD(WEB49_OPCODE_F32X4_NE),
        TABLE_SIMD(WEB49_OPCODE_F32X4_LT),
        TABLE_SIMD(WEB49_OPCODE_F32X4_GT),
        TABLE_SIMD(WEB49_OPCODE_F32X4_LE),
        TABLE_SIMD(WEB49_OPCODE_F32X4_GE),
        TABLE_SIMD(WEB49_OPCODE_F64X2_EQ),
        TABLE_SIMD(WEB49_OPCODE_F64X2_NE),
        TABLE_SIMD(WEB49_OPCODE_F64X2_LT),
        TABLE_SIMD(WEB49_OPCODE_F64X2_GT),
        TABLE_SIMD(WEB49_OPCODE_F64X2_LE),
        TABLE_SIMD(WEB49_OPCODE_F64X2_GE),
        TABLE_SIMD(WEB49_OPCODE_V128_NOT),
        TABLE_SIMD(WEB49_OPCODE_V128_AND),
        TABLE_SIMD(WEB49_OPCODE_V128_ANDNOT),
        TABLE_SIMD(WEB49_OPCODE_V128_OR),
        TABLE_SIMD(WEB49_OPCODE_V128_XOR),
        TABLE_SIMD(WEB49_OPCODE_V128_BITSELECT),
        TABLE_SIMD(WEB49_OPCODE_V128_ANY_TRUE),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD8_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD16_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD32_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD64_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_STORE8_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_STORE16_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_STORE32_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_STORE64_LANE),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD32_ZERO),
        TABLE_SIMD(WEB49_OPCODE_V128_LOAD64_ZERO),
        TABLE_SIMD(WEB49_OPCODE_F32X4_DEMOTE_F64X2_ZERO),
        TABLE_SIMD(WEB49_OPCODE_F64X2_PROMOTE_LOW_F32X4),
        TABLE_SIMD(WEB49_OPCODE_I8X16_ABS),
        TABLE_SIMD(WEB49_OPCODE_I8X16_NEG),
        TABLE_SIMD(WEB49_OPCODE_I8X16_POPCNT),
        TABLE_SIMD(WEB49_OPCODE_I8X16_ALL_TRUE),
        TABLE_SIMD(WEB49_OPCODE_I8X16_BITMASK),
        TABLE_SIMD(WEB49_OPCODE_I8X16_NARROW_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_NARROW_I16X8_U),
        TABLE_SIMD(WEB49_OPCODE_F32X4_CEIL),
        TABLE_SIMD(WEB49_OPCODE_F32X4_FLOOR),
        TABLE_SIMD(WEB49_OPCODE_F32X4_TRUNC),
        TABLE_SIMD(WEB49_OPCODE_F32X4_NEAREST),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SHL),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SHR_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SHR_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_ADD),
        TABLE_SIMD(WEB49_OPCODE_I8X16_ADD_SAT_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_ADD_SAT_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SUB),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SUB_SAT_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_SUB_SAT_U),
        TABLE_SIMD(WEB49_OPCODE_F64X2_CEIL),
        TABLE_SIMD(WEB49_OPCODE_F64X2_FLOOR),
        TABLE_SIMD(WEB49_OPCODE_I8X16_MIN_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_MIN_U),
        TABLE_SIMD(WEB49_OPCODE_I8X16_MAX_S),
        TABLE_SIMD(WEB49_OPCODE_I8X16_MAX_U),
        TABLE_SIMD(WEB49_OPCODE_F64X2_TRUNC),
        TABLE_SIMD(WEB49_OPCODE_I8X16_AVGR_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTADD_PAIRWISE_I8X16_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTADD_PAIRWISE_I8X16_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTADD_PAIRWISE_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTADD_PAIRWISE_I16X8_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_ABS),
        TABLE_SIMD(WEB49_OPCODE_I16X8_NEG),
        TABLE_SIMD(WEB49_OPCODE_I16X8_Q15MULR_SAT_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_ALL_TRUE),
        TABLE_SIMD(WEB49_OPCODE_I16X8_BITMASK),
        TABLE_SIMD(WEB49_OPCODE_I16X8_NARROW_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_NARROW_I32X4_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTEND_LOW_I8X16_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTEND_HIGH_I8X16_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTEND_LOW_I8X16_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTEND_HIGH_I8X16_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SHL),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SHR_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SHR_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_ADD),
        TABLE_SIMD(WEB49_OPCODE_I16X8_ADD_SAT_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_ADD_SAT_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SUB),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SUB_SAT_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_SUB_SAT_U),
        TABLE_SIMD(WEB49_OPCODE_F64X2_NEAREST),
        TABLE_SIMD(WEB49_OPCODE_I16X8_MUL),
        TABLE_SIMD(WEB49_OPCODE_I16X8_MIN_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_MIN_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_MAX_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_MAX_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_AVGR_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTMUL_LOW_I8X16_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTMUL_HIGH_I8X16_S),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTMUL_LOW_I8X16_U),
        TABLE_SIMD(WEB49_OPCODE_I16X8_EXTMUL_HIGH_I8X16_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_ABS),
        TABLE_SIMD(WEB49_OPCODE_I32X4_NEG),
        TABLE_SIMD(WEB49_OPCODE_I32X4_ALL_TRUE),
        TABLE_SIMD(WEB49_OPCODE_I32X4_BITMASK),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTEND_LOW_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTEND_HIGH_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTEND_LOW_I16X8_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTEND_HIGH_I16X8_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_SHL),
        TABLE_SIMD(WEB49_OPCODE_I32X4_SHR_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_SHR_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_ADD),
        TABLE_SIMD(WEB49_OPCODE_I32X4_SUB),
        TABLE_SIMD(WEB49_OPCODE_I32X4_MUL),
        TABLE_SIMD(WEB49_OPCODE_I32X4_MIN_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_MIN_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_MAX_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_MAX_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_DOT_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTMUL_LOW_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTMUL_HIGH_I16X8_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTMUL_LOW_I16X8_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_EXTMUL_HIGH_I16X8_U),
        TABLE_SIMD(WEB49_OPCODE_I64X2_ABS),
        TABLE_SIMD(WEB49_OPCODE_I64X2_NEG),
        TABLE_SIMD(WEB49_OPCODE_I64X2_ALL_TRUE),
        TABLE_SIMD(WEB49_OPCODE_I64X2_BITMASK),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTEND_LOW_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTEND_HIGH_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTEND_LOW_I32X4_U),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTEND_HIGH_I32X4_U),
        TABLE_SIMD(WEB49_OPCODE_I64X2_SHL),
        TABLE_SIMD(WEB49_OPCODE_I64X2_SHR_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_SHR_U),
        TABLE_SIMD(WEB49_OPCODE_I64X2_ADD),
        TABLE_SIMD(WEB49_OPCODE_I64X2_SUB),
        TABLE_SIMD(WEB49_OPCODE_I64X2_MUL),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EQ),
        TABLE_SIMD(WEB49_OPCODE_I64X2_NE),
        TABLE_SIMD(WEB49_OPCODE_I64X2_LT_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_GT_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_LE_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_GE_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTMUL_LOW_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTMUL_HIGH_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTMUL_LOW_I32X4_U),
        TABLE_SIMD(WEB49_OPCODE_I64X2_EXTMUL_HIGH_I32X4_U),
        TABLE_SIMD(WEB49_OPCODE_F32X4_ABS),
        TABLE_SIMD(WEB49_OPCODE_F32X4_NEG),
        TABLE_SIMD(WEB49_OPCODE_F32X4_SQRT),
        TABLE_SIMD(WEB49_OPCODE_F32X4_ADD),
        TABLE_SIMD(WEB49_OPCODE_F32X4_SUB),
        TABLE_SIMD(WEB49_OPCODE_F32X4_MUL),
        TABLE_SIMD(WEB49_OPCODE_F32X4_DIV),
        TABLE_SIMD(WEB49_OPCODE_F32X4_MIN),
        TABLE_SIMD(WEB49_OPCODE_F32X4_MAX),
        TABLE_SIMD(WEB49_OPCODE_F32X4_PMIN),
        TABLE_SIMD(WEB49_OPCODE_F32X4_PMAX),
        TABLE_SIMD(WEB49_OPCODE_F64X2_ABS),
        TABLE_SIMD(WEB49_OPCODE_F64X2_NEG),
        TABLE_SIMD(WEB49_OPCODE_F64X2_SQRT),
        TABLE_SIMD(WEB49_OPCODE_F64X2_ADD),
        TABLE_SIMD(WEB49_OPCODE_F64X2_SUB),
        TABLE_SIMD(WEB49_OPCODE_F64X2_MUL),
        TABLE_SIMD(WEB49_OPCODE_F64X2_DIV),
        TABLE_SIMD(WEB49_OPCODE_F64X2_MIN),
        TABLE_SIMD(WEB49_OPCODE_F64X2_MAX),
        TABLE_SIMD(WEB49_OPCODE_F64X2_PMIN),
        TABLE_SIMD(WEB49_OPCODE_F64X2_PMAX),
        TABLE_SIMD(WEB49_OPCODE_I32X4_TRUNC_SAT_F32X4_S),
        TABLE_SIMD(WEB49_OPCODE_I32X4_TRUNC_SAT_F32X4_U),
        TABLE_SIMD(WEB49_OPCODE_F32X4_CONVERT_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_F32X4_CONVERT_I32X4_U),
        TABLE_SIMD(WEB49_OPCODE_I32X4_TRUNC_SAT_F64X2_S_ZERO),
        TABLE_SIMD(WEB49_OPCODE_I32X4_TRUNC_SAT_F64X2_U_ZERO),
        TABLE_SIMD(WEB49_OPCODE_F64X2_CONVERT_LOW_I32X4_S),
        TABLE_SIMD(WEB49_OPCODE_F64X2_CONVERT_LOW_I32X4_U),
#undef TABLE_PUTV
#undef TABLE_PUT1
#undef TABLE_PUT2
#undef TABLE_SIMD
...
web49_interp_t web49_interp_module(web49_module_t mod) {
    ...
    interp.num_tables = table_section.num_entries;
    interp.tables = web49_malloc(sizeof(web49_interp_table_t) * interp.num_tables);
    for (size_t j = 0; j < table_section.num_entries; j++) {
        web49_type_table_t entry = table_section.entries[j];
        if (entry.element_type == WEB49_TYPE_FUNCREF) {
            interp.tables[j].size = entry.limits.initial;
            interp.tables[j].elems = web49_alloc0(sizeof(void *) * interp.tables[j].size);
        }
    }
    ...
    for (size_t j = 0; j < element_section.num_entries; j++) {
        ...
        for (uint64_t i = 0; i < entry.num_elems; i++) {
            interp.tables[entry.index].elems[i + (uint64_t)entry.offset.immediate.varint32] = &interp.funcs[entry.elems[i]];
        }
    }
...
void web49_free_interp(web49_interp_t interp) {
    ...
    for (size_t i = 0; i < interp.num_tables; i++) {
        web49_free(interp.tables[i].elems);
    }
    web49_free(interp.tables);
}
